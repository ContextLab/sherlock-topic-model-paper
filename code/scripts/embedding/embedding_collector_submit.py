...
job_script = opj(os.path.dirname(os.path.realpath(__file__)), 'embedding_collector.py')
...
for order in range(1, 7):
    job_commands.append(f'{job_script} {order}')
    job_names.append(f'collect_embeddings_{order}')
