...
This repo contains data and code used to produce the paper "_How is experience transformed into memory_" by Andrew C. Heusser and Jeremy R. Manning. The repo is organized as follows:
